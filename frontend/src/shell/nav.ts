...
export const NAV = [
  ...
  { to: '/ai', area: 'ai', label: 'LLM Integration', icon: SparklesIcon, color: '#e879f9', tabs: AI_TABS },
  {
    ...
    color: '#c084fc',
    tabs: [
      { tab: 'store-booth-1', label: 'STORE BOOTH 1', to: '/quant-ai/store-booth-1' },
      { tab: 'connection', label: 'Connection', to: '/quant-ai/connection' },
      { tab: 'command-center', label: 'Agent Command Center', to: '/quant-ai/command-center' },
      { tab: 'monitoring', label: 'Monitoring', to: '/quant-ai/monitoring' },
      { tab: 'settings', label: 'Settings', to: '/quant-ai/settings' },
      { tab: 'data-drive', label: 'Data Drive', to: '/quant-ai/data-drive' },
      { tab: 'templates', label: 'Templates', to: '/quant-ai/templates' },
    ],
    nested: true,
  },
